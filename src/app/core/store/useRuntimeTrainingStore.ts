...
function applyRecordingSyncToJob(
  ...
  const nextSummary = {
    ...
    requestedNumStepsPerEnv: event.requestedNumStepsPerEnv ?? null,
    compiledNumStepsPerEnv: event.compiledNumStepsPerEnv ?? null,
    runtimeNumStepsPerEnv: event.runtimeNumStepsPerEnv ?? null,
    ...
    discrepancyCodes: event.discrepancyCodes ?? [],
    mediaLabelWarnings: event.mediaLabelWarnings ?? [],
    visibleClipProvenance: event.visibleClipProvenance ?? null,
    latestClipProvenance: event.latestClipProvenance ?? null,
    views: event.views,
